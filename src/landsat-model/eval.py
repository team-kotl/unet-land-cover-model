...
def load_and_pad(image_path, mask_path):
    ...
    with rasterio.open(image_path) as src:
        ...
        image = image * 0.0000275 - 0.2  # Landsat scaling
        h, w = image.shape[:2]
...
if __name__ == "__main__":
    evaluate_model(
        model_path="../../models/landsat_model.pth",
        image_path="../../stacked/merged-landsat.tif",
        mask_path="../../truth/landcover-30m.tif",
        output_dir="../../evaluation_results/landsat",
    )
