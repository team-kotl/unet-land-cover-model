...
def main():
    # Load and process data
    image, mask = load_and_preprocess("../../stacked/merged-sentinel.tif", "../../truth/landcover.tif")
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        if avg_val_loss < best_val_loss:
            ...
            torch.save(model.state_dict(), "../../models/sentinel_model.pth")
    ...
    model.load_state_dict(torch.load("../../models/sentinel_model.pth"))
    model.eval()
